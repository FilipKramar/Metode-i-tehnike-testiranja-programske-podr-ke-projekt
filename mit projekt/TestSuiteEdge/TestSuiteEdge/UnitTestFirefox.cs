...
namespace SeleniumTests
{
    ...
    public class SuiteTestFirefox
    {
        ...
        public void TheSearchForTheWebsiteTest()
        {
            ...
            driver.FindElement(By.XPath("//div[@id='rso']/div[3]/div/div/div/div/div/div/div/a/h3")).Click();
        }
        ...
        {
            driver.Navigate().GoToUrl("http://www.bagatshop.hr/hr/");
            driver.FindElement(By.XPath("//img[@alt='Drvena kutija']")).Click();
            driver.FindElement(By.Name("quantity")).Click();
            driver.FindElement(By.Name("quantity")).Clear();
            driver.FindElement(By.Name("quantity")).SendKeys("5,77");
